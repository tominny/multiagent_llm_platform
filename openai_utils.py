...
# Replace with your actual API key or set it via environment variable / st.secrets
config_list = [
    {
        "model": "gpt-4",
...
def generate_usmle_vignette(topic: str) -> Tuple[str, str, str]:
    ...
    try:
        ...
        for msg in conversation_history:
            # We check if msg.get("name") == "Vignette-Maker"
            # because your conversation JSON puts agent names in "name" not "sender"
